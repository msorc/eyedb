...
public abstract class QuicktourCreate extends Benchmark {

	public QuicktourCreate()
	{
	...
	{
		return "Quicktour benchmark, create objects with one-level inheritance, one-to-many and many-to-many relations with referential integrity check";
	}
