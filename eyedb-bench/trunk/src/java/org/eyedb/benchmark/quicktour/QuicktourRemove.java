...
public abstract class QuicktourRemove extends Benchmark {

	public QuicktourRemove()
	{
	}
	...
	{
		return "Quicktour benchmark, delete objects with one-level inheritance, one-to-many and many-to-many relations with referential integrity check";
	}
