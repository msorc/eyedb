...
public class EyeDBQuicktourCollection extends EyeDBQuicktour {

    public String getImplementation()
    {
	return "EyeDB Java implementation using collections";
    }
	...
	for ( int n = 0; n < nCourses; n++) {
	    ...
	    Teacher teacher = teachers[ getRandom().nextInt( teachers.length)];
