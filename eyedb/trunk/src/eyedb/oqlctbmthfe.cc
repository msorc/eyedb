...
#define POSTDB(DB, S) \
  ...
  //
  // int16 object::getDataspaceID() [oqlctbmthfe.cc]
  //

  Status
  __method__OUT_int16_getDataspaceID_object(Database *_db, FEMethod_C *_m, Object *_o, eyedblib::int16 &dspid)
  {
    dspid = _o->getDataspaceID();
    return Success;
  }
