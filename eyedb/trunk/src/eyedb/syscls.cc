...
eyedb::Status AttributeComponent::setClassOwner(eyedb::Class *_class_owner)
{
  ...
  status = getClass()->getAttributes()[4]->setValue(this, (eyedb::Data)&_class_owner, 1, 0);
  return status;
}
...
eyedb::Oid AttributeComponent::getClassOwnerOid(eyedb::Status *rs) 
{
  gbxAutoGarbSuspender _gbxsusp_;
  eyedb::Oid __tmp;
  eyedb::Status s;
...
eyedb::Status AttributeComponentSet::setCompsColl(eyedb::CollSet *_comps)
{
  ...
  status = getClass()->getAttributes()[3]->setValue(this, (eyedb::Data)&_comps, 1, 0);
  return status;
}
...
eyedb::Status AttributeComponentSet::addToCompsColl(AttributeComponent *_comps, eyedb::Bool noDup, const eyedb::IndexImpl *idximpl)
{
  gbxAutoGarbSuspender _gbxsusp_;
  eyedb::Status status;
  CollSet *_coll;
  ...
  if (!_coll)
    {
     ...
     if (_coll_oid.isValid())
       ...
       {
         _coll = new CollSet(db, "", db->getSchema()->getClass("attribute_component"), eyedb::True, idximpl);
       }
    }
...
eyedb::Status AttributeComponentSet::addToCompsColl(const eyedb::Oid &_oid, const eyedb::IndexImpl *idximpl)
{
  gbxAutoGarbSuspender _gbxsusp_;
  eyedb::Status status;
  CollSet *_coll;
  ...
  if (!_coll)
    {
     ...
     if (_coll_oid.isValid())
       ...
       if (status)
        ...
        return eyedb::Exception::make(IDB_ERROR, "no valid collection in attribute AttributeComponentSet::comps");
...
eyedb::Oid AttributeComponentSet::getClassOwnerOid(eyedb::Status *rs) 
{
  gbxAutoGarbSuspender _gbxsusp_;
  eyedb::Oid __tmp;
  eyedb::Status s;
...
eyedb::Status ClassComponent::setClassOwner(eyedb::Class *_class_owner)
{
  ...
  status = getClass()->getAttributes()[2]->setValue(this, (eyedb::Data)&_class_owner, 1, 0);
  return status;
}
...
eyedb::Oid ClassComponent::getClassOwnerOid(eyedb::Status *rs) 
{
  gbxAutoGarbSuspender _gbxsusp_;
  eyedb::Oid __tmp;
  eyedb::Status s;
...
eyedb::Status ClassVariable::setVal(eyedb::Object *_val)
{
  ...
  status = getClass()->getAttributes()[5]->setValue(this, (eyedb::Data)&_val, 1, 0);
  return status;
}
...
eyedb::Oid ClassVariable::getValOid(eyedb::Status *rs) 
{
  gbxAutoGarbSuspender _gbxsusp_;
  eyedb::Oid __tmp;
  eyedb::Status s;
...
eyedb::Status Index::setIdxOid(Oid _idx_oid)
{
  gbxAutoGarbSuspender _gbxsusp_;
  eyedb::Status status;
...
Oid Index::getIdxOid(eyedb::Bool *isnull, eyedb::Status *rs) const
{
  gbxAutoGarbSuspender _gbxsusp_;
  Oid __tmp;
  eyedb::Status s;
...
eyedb::Status HashIndex::setHashMethod(BEMethod_C *_hash_method)
{
  ...
  status = getClass()->getAttributes()[10]->setValue(this, (eyedb::Data)&_hash_method, 1, 0);
  return status;
}
...
eyedb::Oid HashIndex::getHashMethodOid(eyedb::Status *rs) 
{
  gbxAutoGarbSuspender _gbxsusp_;
  eyedb::Oid __tmp;
  eyedb::Status s;
...
static eyedb::StructClass *CollAttrImpl_make(eyedb::StructClass *CollAttrImpl_class = 0, eyedb::Schema *m = 0)
{
  ...
  dims = 0;
  attr[6] = new eyedb::Attribute((m ? m->getClass("int") : eyedb::Int32_Class), "idxtype", eyedb::False, 0, dims);
...
eyedb::Status CollAttrImpl::setIdxtype(eyedblib::int32 _idxtype)
{
  gbxAutoGarbSuspender _gbxsusp_;
  eyedb::Status status;

  status = getClass()->getAttributes()[6]->setValue(this, (eyedb::Data)&_idxtype, 1, 0);
  return status;
}

eyedblib::int32 CollAttrImpl::getIdxtype(eyedb::Bool *isnull, eyedb::Status *rs) const
{
  gbxAutoGarbSuspender _gbxsusp_;
  eyedblib::int32 __tmp = 0;
  eyedb::Status s;
...
eyedb::Status CollAttrImpl::setHashMethod(BEMethod_C *_hash_method)
{
  ...
  status = getClass()->getAttributes()[9]->setValue(this, (eyedb::Data)&_hash_method, 1, 0);
  return status;
}
...
eyedb::Oid CollAttrImpl::getHashMethodOid(eyedb::Status *rs) 
{
  gbxAutoGarbSuspender _gbxsusp_;
  eyedb::Oid __tmp;
  eyedb::Status s;
...
eyedb::Status Signature::setRettype(ArgType *_rettype)
{
  ...
  status = getClass()->getAttributes()[2]->setValue(this, (eyedb::Data)&_rettype, 1, 0);
  return status;
}
...
eyedb::Status Signature::setTypes(unsigned int a0, ArgType *_types)
{
  ...
  status = getClass()->getAttributes()[4]->setValue(this, (eyedb::Data)&_types, 1, from);
  return status;
}
...
eyedb::Status Executable::setSign(Signature *_sign)
{
  ...
  status = getClass()->getAttributes()[5]->setValue(this, (eyedb::Data)&_sign, 1, 0);
  return status;
}
...
eyedb::Status AgregatClassExecutable::setEx(Executable *_ex)
{
  ...
  status = getClass()->getAttributes()[4]->setValue(this, (eyedb::Data)&_ex, 1, 0);
  return status;
}
...
eyedb::Status Trigger::setSuffix(const std::string &_suffix)
{
  ...
  if (len >= 16)
    return eyedb::Exception::make(IDB_ERROR, "string `%s' [%d] too long for attribute Trigger::suffix, maximum is 16\n", _suffix.c_str(), len);
  memset(data, 0, 16);
...
eyedb::Status CardinalityConstraint::setCardDesc(CardinalityDescription *_card_desc)
{
  ...
  status = getClass()->getAttributes()[5]->setValue(this, (eyedb::Data)&_card_desc, 1, 0);
  return status;
}
...
eyedb::Status CardinalityConstraint_Test::setCardDesc(CardinalityDescription *_card_desc)
{
  ...
  status = getClass()->getAttributes()[6]->setValue(this, (eyedb::Data)&_card_desc, 1, 0);
  return status;
}
...
eyedb::Status ProtectionUser::setUser(eyedb::Object *_user)
{
  ...
  status = getClass()->getAttributes()[2]->setValue(this, (eyedb::Data)&_user, 1, 0);
  return status;
}
...
eyedb::Oid ProtectionUser::getUserOid(eyedb::Status *rs) 
{
  gbxAutoGarbSuspender _gbxsusp_;
  eyedb::Oid __tmp;
  eyedb::Status s;
...
eyedb::Status Protection::setPusers(unsigned int a0, ProtectionUser *_pusers)
{
  ...
  status = getClass()->getAttributes()[3]->setValue(this, (eyedb::Data)&_pusers, 1, from);
  return status;
}
...
eyedb::Status Protection::setPoid(Oid _poid)
{
  gbxAutoGarbSuspender _gbxsusp_;
  eyedb::Status status;
...
Oid Protection::getPoid(eyedb::Bool *isnull, eyedb::Status *rs) const
{
  gbxAutoGarbSuspender _gbxsusp_;
  Oid __tmp;
  eyedb::Status s;
...
eyedb::Status ClassConversion::setOidO(Oid _oid_o)
{
  gbxAutoGarbSuspender _gbxsusp_;
  eyedb::Status status;
...
Oid ClassConversion::getOidO(eyedb::Bool *isnull, eyedb::Status *rs) const
{
  gbxAutoGarbSuspender _gbxsusp_;
  Oid __tmp;
  eyedb::Status s;
...
eyedb::Status ClassConversion::setOidN(Oid _oid_n)
{
  gbxAutoGarbSuspender _gbxsusp_;
  eyedb::Status status;
...
Oid ClassConversion::getOidN(eyedb::Bool *isnull, eyedb::Status *rs) const
{
  gbxAutoGarbSuspender _gbxsusp_;
  Oid __tmp;
  eyedb::Status s;
...
eyedb::Status ClassConversion::setRoidO(Oid _roid_o)
{
  gbxAutoGarbSuspender _gbxsusp_;
  eyedb::Status status;
...
Oid ClassConversion::getRoidO(eyedb::Bool *isnull, eyedb::Status *rs) const
{
  gbxAutoGarbSuspender _gbxsusp_;
  Oid __tmp;
  eyedb::Status s;
...
eyedb::Status ClassConversion::setCnvMth(BEMethod_C *_cnv_mth)
{
  ...
  status = getClass()->getAttributes()[18]->setValue(this, (eyedb::Data)&_cnv_mth, 1, 0);
  return status;
}
...
eyedb::Oid ClassConversion::getCnvMthOid(eyedb::Status *rs) 
{
  gbxAutoGarbSuspender _gbxsusp_;
  eyedb::Oid __tmp;
  eyedb::Status s;
...
sysclsSchemaUpdate(eyedb::Schema *m, eyedb::Database *db)
{
  ...
  if (!IndexType_class->compare(m->getClass("index_type")))
    return eyedb::Exception::make(IDB_ERROR, "'IndexType' %s", differ_msg);
  if (!ExecutableLang_class->compare(m->getClass("executable_lang")))
    return eyedb::Exception::make(IDB_ERROR, "'ExecutableLang' %s", differ_msg);
  if (!ArgType_Type_class->compare(m->getClass("argtype_type")))
    return eyedb::Exception::make(IDB_ERROR, "'ArgType_Type' %s", differ_msg);
  if (!ExecutableLocalisation_class->compare(m->getClass("executable_localisation")))
    return eyedb::Exception::make(IDB_ERROR, "'ExecutableLocalisation' %s", differ_msg);
  if (!ExecutableType_class->compare(m->getClass("executable_type")))
    return eyedb::Exception::make(IDB_ERROR, "'ExecutableType' %s", differ_msg);
  if (!TriggerType_class->compare(m->getClass("trigger_type")))
    return eyedb::Exception::make(IDB_ERROR, "'TriggerType' %s", differ_msg);
  if (!ProtectionMode_class->compare(m->getClass("protection_mode")))
    return eyedb::Exception::make(IDB_ERROR, "'ProtectionMode' %s", differ_msg);
  if (!ClassUpdateType_class->compare(m->getClass("class_update_type")))
    return eyedb::Exception::make(IDB_ERROR, "'ClassUpdateType' %s", differ_msg);
  if (!AttributeConvertType_class->compare(m->getClass("attribute_convert_type")))
    return eyedb::Exception::make(IDB_ERROR, "'AttributeConvertType' %s", differ_msg);
  if (!AttributeComponent_class->compare(m->getClass("attribute_component")))
    return eyedb::Exception::make(IDB_ERROR, "'AttributeComponent' %s", differ_msg);
  if (!AttributeComponentSet_class->compare(m->getClass("attribute_component_set")))
    return eyedb::Exception::make(IDB_ERROR, "'AttributeComponentSet' %s", differ_msg);
  if (!ClassComponent_class->compare(m->getClass("class_component")))
    return eyedb::Exception::make(IDB_ERROR, "'ClassComponent' %s", differ_msg);
  if (!AgregatClassComponent_class->compare(m->getClass("agregat_class_component")))
    return eyedb::Exception::make(IDB_ERROR, "'AgregatClassComponent' %s", differ_msg);
  if (!ClassVariable_class->compare(m->getClass("class_variable")))
    return eyedb::Exception::make(IDB_ERROR, "'ClassVariable' %s", differ_msg);
  if (!Index_class->compare(m->getClass("index")))
    return eyedb::Exception::make(IDB_ERROR, "'Index' %s", differ_msg);
  if (!HashIndex_class->compare(m->getClass("hashindex")))
    return eyedb::Exception::make(IDB_ERROR, "'HashIndex' %s", differ_msg);
  if (!BTreeIndex_class->compare(m->getClass("btreeindex")))
    return eyedb::Exception::make(IDB_ERROR, "'BTreeIndex' %s", differ_msg);
  if (!CollAttrImpl_class->compare(m->getClass("collection_attribute_implementation")))
    return eyedb::Exception::make(IDB_ERROR, "'CollAttrImpl' %s", differ_msg);
  if (!ArgType_class->compare(m->getClass("argtype")))
    return eyedb::Exception::make(IDB_ERROR, "'ArgType' %s", differ_msg);
  if (!Signature_class->compare(m->getClass("signature")))
    return eyedb::Exception::make(IDB_ERROR, "'Signature' %s", differ_msg);
  if (!Executable_class->compare(m->getClass("executable")))
    return eyedb::Exception::make(IDB_ERROR, "'Executable' %s", differ_msg);
  if (!AgregatClassExecutable_class->compare(m->getClass("agregat_class_executable")))
    return eyedb::Exception::make(IDB_ERROR, "'AgregatClassExecutable' %s", differ_msg);
  if (!Method_class->compare(m->getClass("method")))
    return eyedb::Exception::make(IDB_ERROR, "'Method' %s", differ_msg);
  if (!FEMethod_class->compare(m->getClass("fe_method")))
    return eyedb::Exception::make(IDB_ERROR, "'FEMethod' %s", differ_msg);
  if (!FEMethod_C_class->compare(m->getClass("fe_method_C")))
    return eyedb::Exception::make(IDB_ERROR, "'FEMethod_C' %s", differ_msg);
  if (!BEMethod_class->compare(m->getClass("be_method")))
    return eyedb::Exception::make(IDB_ERROR, "'BEMethod' %s", differ_msg);
  if (!BEMethod_C_class->compare(m->getClass("be_method_C")))
    return eyedb::Exception::make(IDB_ERROR, "'BEMethod_C' %s", differ_msg);
  if (!BEMethod_OQL_class->compare(m->getClass("be_method_OQL")))
    return eyedb::Exception::make(IDB_ERROR, "'BEMethod_OQL' %s", differ_msg);
  if (!Trigger_class->compare(m->getClass("trigger")))
    return eyedb::Exception::make(IDB_ERROR, "'Trigger' %s", differ_msg);
  if (!UniqueConstraint_class->compare(m->getClass("unique_constraint")))
    return eyedb::Exception::make(IDB_ERROR, "'UniqueConstraint' %s", differ_msg);
  if (!NotNullConstraint_class->compare(m->getClass("notnull_constraint")))
    return eyedb::Exception::make(IDB_ERROR, "'NotNullConstraint' %s", differ_msg);
  if (!CardinalityDescription_class->compare(m->getClass("cardinality_description")))
    return eyedb::Exception::make(IDB_ERROR, "'CardinalityDescription' %s", differ_msg);
  if (!CardinalityConstraint_class->compare(m->getClass("cardinality_constraint")))
    return eyedb::Exception::make(IDB_ERROR, "'CardinalityConstraint' %s", differ_msg);
  if (!CardinalityConstraint_Test_class->compare(m->getClass("cardinality_constraint_test")))
    return eyedb::Exception::make(IDB_ERROR, "'CardinalityConstraint_Test' %s", differ_msg);
  if (!ProtectionUser_class->compare(m->getClass("protection_user")))
    return eyedb::Exception::make(IDB_ERROR, "'ProtectionUser' %s", differ_msg);
  if (!Protection_class->compare(m->getClass("protection")))
    return eyedb::Exception::make(IDB_ERROR, "'Protection' %s", differ_msg);
  if (!UnreadableObject_class->compare(m->getClass("unreadable_object")))
    return eyedb::Exception::make(IDB_ERROR, "'UnreadableObject' %s", differ_msg);
  if (!ClassConversion_class->compare(m->getClass("class_conversion")))
    return eyedb::Exception::make(IDB_ERROR, "'ClassConversion' %s", differ_msg);
...
eyedb::Status sysclsDatabase::open(eyedb::Connection *ch, eyedb::Database::OpenFlag flag, const char *userauth, const char *passwdauth)
{
    return open(ch, flag, 0, userauth, passwdauth);
}

eyedb::Status sysclsDatabase::open(eyedb::Connection *ch, eyedb::Database::OpenFlag flag, const eyedb::OpenHints *hints, const char *userauth, const char *passwdauth)
{
  eyedb::Status status = eyedb::Database::open(ch, flag, hints, userauth, passwdauth);
  if (status) return status;
  transactionBegin();
...
eyedb::Bool sysclsDatabase::getDynamicGetErrorPolicy() {
   throw *eyedb::Exception::make(IDB_ERROR, "getDynamicGetErrorPolicy() can be called only when the dynamic attribute fonctionnality is on (-dynamic-attr option of eyedbodl)");
}

eyedb::Bool sysclsDatabase::getDynamicSetErrorPolicy() {
   throw *eyedb::Exception::make(IDB_ERROR, "getDynamicSetErrorPolicy() can be called only when the dynamic attribute fonctionnality is on (-dynamic-attr option of eyedbodl)");
}

void sysclsDatabase::setDynamicGetErrorPolicy(eyedb::Bool policy) {
   throw *eyedb::Exception::make(IDB_ERROR, "setDynamicGetErrorPolicy() can be called only when the dynamic attribute fonctionnality is on (-dynamic-attr option of eyedbodl)");
}

void sysclsDatabase::setDynamicSetErrorPolicy(eyedb::Bool policy) {
   throw *eyedb::Exception::make(IDB_ERROR, "setDynamicSetErrorPolicy() can be called only when the dynamic attribute fonctionnality is on (-dynamic-attr option of eyedbodl)");
}
