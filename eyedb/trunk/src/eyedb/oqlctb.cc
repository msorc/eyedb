...
static eyedb::Status object_comp_realize(eyedb::Database *db, eyedb::Class *cls)
{
  ...
  argtype->setType((ArgType_Type)8200, eyedb::False);
  argtype->setClname("");
  sign->setNargs(0);
  ...
  sign = new eyedb::Signature();
  argtype = sign->getRettype();
  argtype->setType((ArgType_Type)8197, eyedb::False);
  argtype->setClname("");
  sign->setNargs(0);
  sign->setTypesCount(0);
  ...
  argtype->setType((ArgType_Type)4099, eyedb::False);
  argtype->setClname("");
  comp = new eyedb::FEMethod_C(db, cls, "toString", sign, eyedb::False, eyedb::True, "oqlctbmthfe");
  if (status = comp->realize()) return status;
  ...
  sign = new eyedb::Signature();
  argtype = sign->getRettype();
  argtype->setType((ArgType_Type)8201, eyedb::False);
  ...
  sign = new eyedb::Signature();
  argtype = sign->getRettype();
  argtype->setType((ArgType_Type)8193, eyedb::False);
  argtype->setClname("");
  sign->setNargs(1);
  sign->setTypesCount(1);
  argtype = sign->getTypes(0);
  argtype->setType((ArgType_Type)4105, eyedb::False);
  argtype->setClname("database");
  ...
  sign = new eyedb::Signature();
  argtype = sign->getRettype();
  argtype->setType((ArgType_Type)8196, eyedb::False);
  argtype->setClname("");
  sign->setNargs(0);
  sign->setTypesCount(0);
  ...
  sign = new eyedb::Signature();
  argtype = sign->getRettype();
  argtype->setType((ArgType_Type)8195, eyedb::False);
...
eyedb::Status OqlCtbDatafile::setDsp(OqlCtbDataspace *_dsp)
{
  ...
  status = getClass()->getAttributes()[4]->setValue(this, (eyedb::Data)&_dsp, 1, 0);
  return status;
}
...
eyedb::Oid OqlCtbDatafile::getDspOid(eyedb::Status *rs) 
{
  gbxAutoGarbSuspender _gbxsusp_;
  eyedb::Oid __tmp;
  eyedb::Status s;
...
eyedb::Status OqlCtbDataspace::setDatafiles(unsigned int a0, OqlCtbDatafile *_datafiles)
{
  ...
  status = getClass()->getAttributes()[4]->setValue(this, (eyedb::Data)&_datafiles, 1, from);
  return status;
}
...
eyedb::Oid OqlCtbDataspace::getDatafilesOid(unsigned int a0, eyedb::Status *rs) 
{
  gbxAutoGarbSuspender _gbxsusp_;
  eyedb::Oid __tmp;
  eyedb::Status s;
...
static eyedb::Status index_comp_realize(eyedb::Database *db, eyedb::Class *cls)
{
  ...
  argtype->setClname("");
  argtype = sign->getTypes(1);
  argtype->setType((ArgType_Type)4101, eyedb::False);
  argtype->setClname("");
...
static eyedb::Status collection_comp_realize(eyedb::Database *db, eyedb::Class *cls)
{
  ...
  sign->setTypesCount(1);
  argtype = sign->getTypes(0);
  argtype->setType((ArgType_Type)4104, eyedb::False);
  argtype->setClname("");
  ...
  sign = new eyedb::Signature();
  argtype = sign->getRettype();
  argtype->setType((ArgType_Type)8456, eyedb::False);
  argtype->setClname("");
  sign->setNargs(1);
  sign->setTypesCount(1);
  argtype = sign->getTypes(0);
...
static eyedb::Status OqlCtbDatabase_comp_realize(eyedb::Database *db, eyedb::Class *cls)
{
  ...
  sign = new eyedb::Signature();
  argtype = sign->getRettype();
  argtype->setType((ArgType_Type)8457, eyedb::False);
  ...
  sign->setTypesCount(1);
  argtype = sign->getTypes(0);
  argtype->setType((ArgType_Type)4098, eyedb::False);
  argtype->setClname("");
  comp = new eyedb::FEMethod_C(db, cls, "getDatafile", sign, eyedb::False, eyedb::True, "oqlctbmthfe");
  cls->add(comp->getInd(), comp);
  ...
  sign->setTypesCount(2);
  argtype = sign->getTypes(0);
  argtype->setType((ArgType_Type)4360, eyedb::False);
  argtype->setClname("");
  argtype = sign->getTypes(1);
  argtype->setType((ArgType_Type)4105, eyedb::False);
  argtype->setClname("dataspace");
  ...
  argtype->setType((ArgType_Type)4101, eyedb::False);
  argtype->setClname("");
  comp = new eyedb::FEMethod_C(db, cls, "updateScheme", sign, eyedb::False, eyedb::True, "oqlctbmthfe");
  cls->add(comp->getInd(), comp);
...
static eyedb::Status OqlCtbMath_comp_realize(eyedb::Database *db, eyedb::Class *cls)
{
  ...
  sign = new eyedb::Signature();
  argtype = sign->getRettype();
  argtype->setType((ArgType_Type)8199, eyedb::False);
  argtype->setClname("");
  sign->setNargs(1);
  sign->setTypesCount(1);
  argtype = sign->getTypes(0);
  argtype->setType((ArgType_Type)4103, eyedb::False);
  argtype->setClname("");
...
oqlctbSchemaUpdate(eyedb::Schema *m, eyedb::Database *db)
{
  ...
  if (!OqlCtbDatabaseOpenMode_class->compare(m->getClass("database_open_mode")))
    return eyedb::Exception::make(IDB_ERROR, "'OqlCtbDatabaseOpenMode' %s", differ_msg);
  if (!OqlCtbLockMode_class->compare(m->getClass("lock_mode")))
    return eyedb::Exception::make(IDB_ERROR, "'OqlCtbLockMode' %s", differ_msg);
  if (!OqlCtbTransactionMode_class->compare(m->getClass("transaction_mode")))
    return eyedb::Exception::make(IDB_ERROR, "'OqlCtbTransactionMode' %s", differ_msg);
  if (!OqlCtbTransactionLockMode_class->compare(m->getClass("transaction_lockmode")))
    return eyedb::Exception::make(IDB_ERROR, "'OqlCtbTransactionLockMode' %s", differ_msg);
  if (!OqlCtbRecoveryMode_class->compare(m->getClass("recovery_mode")))
    return eyedb::Exception::make(IDB_ERROR, "'OqlCtbRecoveryMode' %s", differ_msg);
  if (!OqlCtbToStringFlags_class->compare(m->getClass("tostring_flags")))
    return eyedb::Exception::make(IDB_ERROR, "'OqlCtbToStringFlags' %s", differ_msg);
  if (!OqlCtbMapType_class->compare(m->getClass("MapType")))
    return eyedb::Exception::make(IDB_ERROR, "'OqlCtbMapType' %s", differ_msg);
  if (!OqlCtbDatType_class->compare(m->getClass("DatType")))
    return eyedb::Exception::make(IDB_ERROR, "'OqlCtbDatType' %s", differ_msg);
  if (!OqlCtbDatafile_class->compare(m->getClass("datafile")))
    return eyedb::Exception::make(IDB_ERROR, "'OqlCtbDatafile' %s", differ_msg);
  if (!OqlCtbDataspace_class->compare(m->getClass("dataspace")))
    return eyedb::Exception::make(IDB_ERROR, "'OqlCtbDataspace' %s", differ_msg);
  if (!OqlCtbEyedb_class->compare(m->getClass("eyedb")))
    return eyedb::Exception::make(IDB_ERROR, "'OqlCtbEyedb' %s", differ_msg);
  if (!OqlCtbConnection_class->compare(m->getClass("connection")))
    return eyedb::Exception::make(IDB_ERROR, "'OqlCtbConnection' %s", differ_msg);
  if (!OqlCtbDatabase_class->compare(m->getClass("database")))
    return eyedb::Exception::make(IDB_ERROR, "'OqlCtbDatabase' %s", differ_msg);
  if (!OqlCtbMath_class->compare(m->getClass("math")))
    return eyedb::Exception::make(IDB_ERROR, "'OqlCtbMath' %s", differ_msg);
  if (!oql_class->compare(m->getClass("oql")))
    return eyedb::Exception::make(IDB_ERROR, "'oql' %s", differ_msg);
...
eyedb::Status oqlctbDatabase::open(eyedb::Connection *ch, eyedb::Database::OpenFlag flag, const char *userauth, const char *passwdauth)
{
    return open(ch, flag, 0, userauth, passwdauth);
}

eyedb::Status oqlctbDatabase::open(eyedb::Connection *ch, eyedb::Database::OpenFlag flag, const eyedb::OpenHints *hints, const char *userauth, const char *passwdauth)
{
