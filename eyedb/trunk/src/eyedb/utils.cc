...
eyedb::Status utilsDatabase::open(eyedb::Connection *ch, eyedb::Database::OpenFlag flag, const char *userauth, const char *passwdauth)
{
    return open(ch, flag, 0, userauth, passwdauth);
}

eyedb::Status utilsDatabase::open(eyedb::Connection *ch, eyedb::Database::OpenFlag flag, const eyedb::OpenHints *hints, const char *userauth, const char *passwdauth)
{
