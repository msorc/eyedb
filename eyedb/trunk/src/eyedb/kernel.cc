...
#undef hdr
  ...
  RPCStatus
  IDB_dataSizeGet(DbHandle *dbh, const eyedbsm::Oid *oid, unsigned int *psize)
  {
    return rpcStatusMake_se(eyedbsm::objectSizeGet(dbh->sedbh, psize, eyedbsm::DefaultLock, oid));
  }
		       ...
		       ObjectHeader *hdr, eyedbsm::Oid *oid, void *xdata)
  {
    ...
    /*
      ...
      printf("creating collection %s\n", (const char *)idximpl->getHintsString());
    */
