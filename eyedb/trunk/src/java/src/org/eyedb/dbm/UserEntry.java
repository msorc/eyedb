...
public class UserEntry extends Root {
  ...
  static StructClass make(StructClass UserEntry_class, org.eyedb.Schema m)
   throws org.eyedb.Exception {
    if (UserEntry_class == null)
      return new StructClass("user_entry", ((m != null) ? m.getClass("Root") : Root.idbclass));
    ...
    dims = new int[1];
    dims[0] = -1;
    attr[3] = new org.eyedb.Attribute(((m != null) ? m.getClass("char") : Char.idbclass), idbclass, "passwd", 3, false, 1, dims);

    dims = null;
    attr[4] = new org.eyedb.Attribute(((m != null) ? m.getClass("int") : Int32.idbclass), idbclass, "uid", 4, false, 0, dims);
