...
public class SysUserAccess extends Root {
  ...
  static org.eyedb.StructClass make(org.eyedb.StructClass SysUserAccess_class, org.eyedb.Schema m)
   throws org.eyedb.Exception {
    ...
    dims = null;
    attr[2] = new org.eyedb.Attribute(((m != null) ? m.getClass("user_entry") : UserEntry.idbclass), idbclass, "UserEntry", 2, true, 0, dims);

    dims = null;
    attr[3] = new org.eyedb.Attribute(((m != null) ? m.getClass("system_access_mode") : SysAccessMode.idbclass), idbclass, "SysAccessMode", 3, false, 0, dims);
