...
public class DBUserAccess extends Root {
  ...
  static org.eyedb.StructClass make(org.eyedb.StructClass DBUserAccess_class, org.eyedb.Schema m)
   throws org.eyedb.Exception {
    ...
    dims = null;
    attr[3] = new org.eyedb.Attribute(((m != null) ? m.getClass("user_entry") : UserEntry.idbclass), idbclass, "UserEntry", 3, true, 0, dims);

    dims = null;
    attr[4] = new org.eyedb.Attribute(((m != null) ? m.getClass("database_access_mode") : DBAccessMode.idbclass), idbclass, "DBAccessMode", 4, false, 0, dims);
