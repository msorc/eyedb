...
//
// Generated by eyedbodl at Sat Dec 10 15:58:38 2005
//
...
public class DBEntry extends Root {
  ...
  static org.eyedb.StructClass make(org.eyedb.StructClass DBEntry_class, org.eyedb.Schema m)
   throws org.eyedb.Exception {
    ...
    dims = null;
    attr[3] = new org.eyedb.Attribute(((m != null) ? m.getClass("int") : org.eyedb.Int32.idbclass), idbclass, "org.eyedb.Int32", 3, false, 0, dims);
    ...
    dims = null;
    attr[5] = new org.eyedb.Attribute(((m != null) ? m.getClass("database_access_mode") : DBAccessMode.idbclass), idbclass, "DBAccessMode", 5, false, 0, dims);

    dims = null;
    attr[6] = new org.eyedb.Attribute(((m != null) ? m.getClass("object") : org.eyedb.Object.idbclass), idbclass, "org.eyedb.Object", 6, true, 0, dims);
    ...
    dims = new int[1];
    dims[0] = -1;
    attr[8] = new org.eyedb.Attribute(((m != null) ? m.getClass("database_property") : DBProperty.idbclass), idbclass, "DBProperty", 8, true, 1, dims);
