...
public class AttributeComponent extends Root {
  ...
  static StructClass make(StructClass AttributeComponent_class, org.eyedb.Schema m)
   throws org.eyedb.Exception {
    if (AttributeComponent_class == null)
      return new StructClass("attribute_component", ((m != null) ? m.getClass("Root") : Root.idbclass));
    ...
    dims = new int[1];
    dims[0] = -1;
    attr[3] = new org.eyedb.Attribute(((m != null) ? m.getClass("char") : Char.idbclass), idbclass, "attrpath", 3, false, 1, dims);
