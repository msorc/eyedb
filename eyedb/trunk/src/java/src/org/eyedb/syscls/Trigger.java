  ...
  static org.eyedb.StructClass make(org.eyedb.StructClass Trigger_class, org.eyedb.Schema m)
   throws org.eyedb.Exception {
    if (Trigger_class == null)
      return new org.eyedb.StructClass("trigger", ((m != null) ? m.getClass("AgregatClassExecutable") : AgregatClassExecutable.idbclass));
    org.eyedb.Attribute[] attr = new org.eyedb.Attribute[8];
    int[] dims;

    dims = null;
    attr[5] = new org.eyedb.Attribute(((m != null) ? m.getClass("trigger_type") : TriggerType.idbclass), idbclass, "TriggerType", 5, false, 0, dims);
