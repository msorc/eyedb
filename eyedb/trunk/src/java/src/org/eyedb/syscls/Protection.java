...
public class Protection extends Root {
  ...
  static org.eyedb.StructClass make(org.eyedb.StructClass Protection_class, org.eyedb.Schema m)
   throws org.eyedb.Exception {
    ...
    dims = new int[1];
    dims[0] = -1;
    attr[3] = new org.eyedb.Attribute(((m != null) ? m.getClass("protection_user") : ProtectionUser.idbclass), idbclass, "ProtectionUser", 3, false, 1, dims);

    dims = null;
    attr[4] = new org.eyedb.Attribute(((m != null) ? m.getClass("oid") : org.eyedb.OidP.idbclass), idbclass, "org.eyedb.OidP", 4, false, 0, dims);
