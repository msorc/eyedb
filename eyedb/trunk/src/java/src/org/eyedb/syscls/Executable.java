...
public class Executable extends Root {
  ...
  static org.eyedb.StructClass make(org.eyedb.StructClass Executable_class, org.eyedb.Schema m)
   throws org.eyedb.Exception {
    ...
    dims = null;
    attr[3] = new org.eyedb.Attribute(((m != null) ? m.getClass("executable_lang") : ExecutableLang.idbclass), idbclass, "ExecutableLang", 3, false, 0, dims);

    dims = null;
    attr[4] = new org.eyedb.Attribute(((m != null) ? m.getClass("executable_localisation") : ExecutableLocalisation.idbclass), idbclass, "ExecutableLocalisation", 4, false, 0, dims);

    dims = null;
    attr[5] = new org.eyedb.Attribute(((m != null) ? m.getClass("signature") : Signature.idbclass), idbclass, "Signature", 5, false, 0, dims);

    dims = new int[1];
    dims[0] = -1;
    attr[6] = new org.eyedb.Attribute(((m != null) ? m.getClass("char") : org.eyedb.Char.idbclass), idbclass, "org.eyedb.Char", 6, false, 1, dims);
