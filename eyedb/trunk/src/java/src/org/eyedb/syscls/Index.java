...
public class Index extends AttributeComponent {
  ...
  static StructClass make(StructClass Index_class, org.eyedb.Schema m)
   throws org.eyedb.Exception {
    if (Index_class == null)
      return new StructClass("index", ((m != null) ? m.getClass("AttributeComponent") : AttributeComponent.idbclass));
    org.eyedb.Attribute[] attr = new org.eyedb.Attribute[10];
    int[] dims;

    dims = null;
    attr[6] = new org.eyedb.Attribute(((m != null) ? m.getClass("oid") : OidP.idbclass), idbclass, "idx_oid", 6, false, 0, dims);
    ...
    dims = new int[1];
    dims[0] = -1;
    attr[9] = new org.eyedb.Attribute(((m != null) ? m.getClass("int") : Int32.idbclass), idbclass, "impl_hints", 9, false, 1, dims);
