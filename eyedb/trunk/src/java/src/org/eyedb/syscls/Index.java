...
public class Index extends AttributeComponent {
  ...
  static org.eyedb.StructClass make(org.eyedb.StructClass Index_class, org.eyedb.Schema m)
   throws org.eyedb.Exception {
    if (Index_class == null)
      return new org.eyedb.StructClass("index", ((m != null) ? m.getClass("AttributeComponent") : AttributeComponent.idbclass));
    org.eyedb.Attribute[] attr = new org.eyedb.Attribute[10];
    int[] dims;

    dims = null;
    attr[6] = new org.eyedb.Attribute(((m != null) ? m.getClass("oid") : org.eyedb.OidP.idbclass), idbclass, "org.eyedb.OidP", 6, false, 0, dims);

    dims = null;
    attr[7] = new org.eyedb.Attribute(((m != null) ? m.getClass("short") : org.eyedb.Int16.idbclass), idbclass, "org.eyedb.Int16", 7, false, 0, dims);

    dims = null;
    attr[8] = new org.eyedb.Attribute(((m != null) ? m.getClass("bool") : org.eyedb.Bool.idbclass), idbclass, "org.eyedb.Bool", 8, false, 0, dims);

    dims = new int[1];
    dims[0] = -1;
    attr[9] = new org.eyedb.Attribute(((m != null) ? m.getClass("int") : org.eyedb.Int32.idbclass), idbclass, "org.eyedb.Int32", 9, false, 1, dims);
