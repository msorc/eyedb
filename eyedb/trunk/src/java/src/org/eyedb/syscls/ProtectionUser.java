...
public class ProtectionUser extends Root {
  ...
  static org.eyedb.StructClass make(org.eyedb.StructClass ProtectionUser_class, org.eyedb.Schema m)
   throws org.eyedb.Exception {
    ...
    dims = null;
    attr[2] = new org.eyedb.Attribute(((m != null) ? m.getClass("object") : org.eyedb.Object.idbclass), idbclass, "org.eyedb.Object", 2, true, 0, dims);

    dims = null;
    attr[3] = new org.eyedb.Attribute(((m != null) ? m.getClass("protection_mode") : ProtectionMode.idbclass), idbclass, "ProtectionMode", 3, false, 0, dims);
