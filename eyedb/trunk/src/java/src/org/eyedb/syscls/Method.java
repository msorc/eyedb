...
public class Method extends AgregatClassExecutable {
  ...
  static StructClass make(StructClass Method_class, org.eyedb.Schema m)
   throws org.eyedb.Exception {
    if (Method_class == null)
      return new StructClass("method", ((m != null) ? m.getClass("AgregatClassExecutable") : AgregatClassExecutable.idbclass));
