  ...
  static org.eyedb.StructClass make(org.eyedb.StructClass AgregatClassExecutable_class, org.eyedb.Schema m)
   throws org.eyedb.Exception {
    if (AgregatClassExecutable_class == null)
      return new org.eyedb.StructClass("agregat_class_executable", ((m != null) ? m.getClass("AgregatClassComponent") : AgregatClassComponent.idbclass));
    org.eyedb.Attribute[] attr = new org.eyedb.Attribute[5];
    int[] dims;

    dims = null;
    attr[4] = new org.eyedb.Attribute(((m != null) ? m.getClass("executable") : Executable.idbclass), idbclass, "Executable", 4, false, 0, dims);
