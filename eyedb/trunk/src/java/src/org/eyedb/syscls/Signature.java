...
public class Signature extends Root {
  ...
  static org.eyedb.StructClass make(org.eyedb.StructClass Signature_class, org.eyedb.Schema m)
   throws org.eyedb.Exception {
    ...
    dims = null;
    attr[2] = new org.eyedb.Attribute(((m != null) ? m.getClass("argtype") : ArgType.idbclass), idbclass, "ArgType", 2, false, 0, dims);
    ...
    dims = new int[1];
    dims[0] = -1;
    attr[4] = new org.eyedb.Attribute(((m != null) ? m.getClass("argtype") : ArgType.idbclass), idbclass, "ArgType", 4, false, 1, dims);
