  ...
  static org.eyedb.StructClass make(org.eyedb.StructClass CollAttrImpl_class, org.eyedb.Schema m)
   throws org.eyedb.Exception {
    if (CollAttrImpl_class == null)
      return new org.eyedb.StructClass("collection_attribute_implementation", ((m != null) ? m.getClass("AttributeComponent") : AttributeComponent.idbclass));
    ...
    dims = null;
    attr[7] = new org.eyedb.Attribute(((m != null) ? m.getClass("short") : org.eyedb.Int16.idbclass), idbclass, "org.eyedb.Int16", 7, false, 0, dims);

    dims = null;
    attr[8] = new org.eyedb.Attribute(((m != null) ? m.getClass("int") : org.eyedb.Int32.idbclass), idbclass, "org.eyedb.Int32", 8, false, 0, dims);

    dims = null;
    attr[9] = new org.eyedb.Attribute(((m != null) ? m.getClass("be_method_C") : BEMethod_C.idbclass), idbclass, "BEMethod_C", 9, true, 0, dims);

    dims = new int[1];
    dims[0] = -1;
    attr[10] = new org.eyedb.Attribute(((m != null) ? m.getClass("int") : org.eyedb.Int32.idbclass), idbclass, "org.eyedb.Int32", 10, false, 1, dims);
