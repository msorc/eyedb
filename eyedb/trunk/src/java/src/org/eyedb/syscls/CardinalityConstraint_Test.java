  ...
  static org.eyedb.StructClass make(org.eyedb.StructClass CardinalityConstraint_Test_class, org.eyedb.Schema m)
   throws org.eyedb.Exception {
    if (CardinalityConstraint_Test_class == null)
      return new org.eyedb.StructClass("cardinality_constraint_test", ((m != null) ? m.getClass("AttributeComponent") : AttributeComponent.idbclass));
    org.eyedb.Attribute[] attr = new org.eyedb.Attribute[7];
    int[] dims;

    dims = null;
    attr[6] = new org.eyedb.Attribute(((m != null) ? m.getClass("cardinality_description") : CardinalityDescription.idbclass), idbclass, "CardinalityDescription", 6, false, 0, dims);
