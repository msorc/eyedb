...
public class AttributeComponentSet extends Root {
  ...
  static org.eyedb.StructClass make(org.eyedb.StructClass AttributeComponentSet_class, org.eyedb.Schema m)
   throws org.eyedb.Exception {
    ...
    dims = null;
    attr[3] = new org.eyedb.Attribute(((m != null) ? m.getClass("set<attribute_component*>") : set_class_AttributeComponent_ref.idbclass), idbclass, "org.eyedb.CollSet", 3, false, 0, dims);

    dims = null;
    attr[4] = new org.eyedb.Attribute(((m != null) ? m.getClass("class") : org.eyedb.Class.idbclass), idbclass, "org.eyedb.Class", 4, true, 0, dims);
