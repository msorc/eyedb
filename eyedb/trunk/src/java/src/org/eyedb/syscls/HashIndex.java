  ...
  static org.eyedb.StructClass make(org.eyedb.StructClass HashIndex_class, org.eyedb.Schema m)
   throws org.eyedb.Exception {
    if (HashIndex_class == null)
      return new org.eyedb.StructClass("hashindex", ((m != null) ? m.getClass("Index") : Index.idbclass));
    org.eyedb.Attribute[] attr = new org.eyedb.Attribute[12];
    int[] dims;

    dims = null;
    attr[10] = new org.eyedb.Attribute(((m != null) ? m.getClass("be_method_C") : BEMethod_C.idbclass), idbclass, "BEMethod_C", 10, true, 0, dims);
