...
public class BEMethod_C extends BEMethod {
  ...
  static StructClass make(StructClass BEMethod_C_class, org.eyedb.Schema m)
   throws org.eyedb.Exception {
    if (BEMethod_C_class == null)
      return new StructClass("be_method_C", ((m != null) ? m.getClass("BEMethod") : BEMethod.idbclass));
