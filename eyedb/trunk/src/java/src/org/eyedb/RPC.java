...
class RPC extends RPClib {
    ...
    static public final int INDEX_GET_COUNT = 0x100+0x40;
    static public final int INDEX_GET_STATS = 0x100+0x41;
    static public final int INDEX_SIMUL_STATS = 0x100+0x42;
    static public final int COLLECTION_GET_IMPLSTATS = 0x100+0x43;
    static public final int COLLECTION_SIMUL_IMPLSTATS = 0x100+0x44;
    static public final int INDEX_GET_IMPL = 0x100+0x45;
    static public final int COLLECTION_GET_IMPL = 0x100+0x46;
    static public final int OBJECT_PROTECTION_SET = 0x100+0x47;
    static public final int OBJECT_PROTECTION_GET = 0x100+0x48;
    static public final int OQL_CREATE = 0x100+0x49;
    static public final int OQL_DELETE = 0x100+0x4a;
    static public final int OQL_GETRESULT = 0x100+0x4b;
    static public final int SET_LOG_MASK = 0x100+0x4c;
    static public final int GET_DEFAULT_DATASPACE = 0x100+0x4d;
    static public final int SET_DEFAULT_DATASPACE = 0x100+0x4e;
    static public final int DATASPACE_SET_CURRENT_DATAFILE = 0x100+0x4f;
    static public final int DATASPACE_GET_CURRENT_DATAFILE = 0x100+0x50;
    static public final int GET_DEFAULT_INDEX_DATASPACE = 0x100+0x51;
    static public final int SET_DEFAULT_INDEX_DATASPACE = 0x100+0x52;
    static public final int GET_INDEX_LOCATIONS = 0x100+0x53;
    static public final int MOVE_INDEX = 0x100+0x54;
    static public final int GET_INSTANCE_CLASS_LOCATIONS = 0x100+0x55;
    static public final int MOVE_INSTANCE_CLASS = 0x100+0x56;
    static public final int GET_OBJECTS_LOCATIONS = 0x100+0x57;
    static public final int MOVE_OBJECTS = 0x100+0x58;
    static public final int GET_ATTRIBUTE_LOCATIONS = 0x100+0x59;
    static public final int MOVE_ATTRIBUTE = 0x100+0x5a;
    static public final int CREATE_DATAFILE = 0x100+0x5b;
    static public final int DELETE_DATAFILE = 0x100+0x5c;
    static public final int MOVE_DATAFILE = 0x100+0x5d;
    static public final int DEFRAGMENT_DATAFILE = 0x100+0x5e;
    static public final int RESIZE_DATAFILE = 0x100+0x5f;
    static public final int GET_DATAFILEI_NFO = 0x100+0x60;
    static public final int RENAME_DATAFILE = 0x100+0x61;
    static public final int CREATE_DATASPACE = 0x100+0x62;
    static public final int UPDATE_DATASPACE = 0x100+0x63;
    static public final int DELETE_DATASPACE = 0x100+0x64;
    static public final int RENAME_DATASPACE = 0x100+0x65;
    static public final int GET_SERVER_OUTOFBAND_DATA = 0x100+0x66;
