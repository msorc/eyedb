...
class RPC extends RPClib {
    ...
    static public final int IDB_DBMCREATE = 0x100;
    static public final int IDB_DBMUPDATE = 0x100+0x1;
    static public final int IDB_DBCREATE = 0x100+0x2;
    static public final int IDB_DBDELETE = 0x100+0x3;
    static public final int IDB_USER_ADD = 0x100+0x4;
    static public final int IDB_USER_DELETE = 0x100+0x5;
    static public final int IDB_USER_PASSWD_SET = 0x100+0x6;
    static public final int IDB_PASSWD_SET = 0x100+0x7;
    static public final int IDB_DEFAULT_DBACCESS_SET = 0x100+0x8;
    static public final int IDB_USER_DBACCESS_SET = 0x100+0x9;
    static public final int IDB_USER_SYSACCESS_SET = 0x100+0xa;
    static public final int IDB_DBINFO = 0x100+0xb;
    static public final int IDB_DBMOVE = 0x100+0xc;
    static public final int IDB_DBCOPY = 0x100+0xd;
    static public final int IDB_DBRENAME = 0x100+0xe;
    static public final int IDB_BACKEND_INTERRUPT = 0x100+0xf;
    static public final int IDB_TRANSACTION_BEGIN = 0x100+0x10;
    static public final int IDB_TRANSACTION_COMMIT = 0x100+0x11;
    static public final int IDB_TRANSACTION_ABORT = 0x100+0x12;
    static public final int IDB_TRANSACTION_PARAMS_SET = 0x100+0x13;
    static public final int IDB_TRANSACTION_PARAMS_GET = 0x100+0x14;
    static public final int IDB_DBOPEN = 0x100+0x15;
    static public final int IDB_DBOPENLOCAL = 0x100+0x16;
    static public final int IDB_DBCLOSE = 0x100+0x17;
    static public final int IDB_OBJECT_CREATE = 0x100+0x18;
    static public final int IDB_OBJECT_READ = 0x100+0x19;
    static public final int IDB_OBJECT_WRITE = 0x100+0x1a;
    static public final int IDB_OBJECT_DELETE = 0x100+0x1b;
    static public final int IDB_OBJECT_HEADER_READ = 0x100+0x1c;
    static public final int IDB_OBJECT_SIZE_MODIFY = 0x100+0x1d;
    static public final int IDB_OBJECT_CHECK = 0x100+0x1e;
    static public final int IDB_OID_MAKE = 0x100+0x1f;
    static public final int IDB_DATA_CREATE = 0x100+0x20;
    static public final int IDB_DATA_READ = 0x100+0x21;
    static public final int IDB_DATA_WRITE = 0x100+0x22;
    static public final int IDB_DATA_DELETE = 0x100+0x23;
    static public final int IDB_DATA_SIZE_GET = 0x100+0x24;
    static public final int IDB_DATA_SIZE_MODIFY = 0x100+0x25;
    static public final int IDB_VDDATA_CREATE = 0x100+0x26;
    static public final int IDB_VDDATA_WRITE = 0x100+0x27;
    static public final int IDB_VDDATA_DELETE = 0x100+0x28;
    static public final int IDB_SCHEMA_COMPLETE = 0x100+0x29;
    static public final int IDB_ATTRIBUTE_INDEX_CREATE = 0x100+0x2a;
    static public final int IDB_ATTRIBUTE_INDEX_REMOVE = 0x100+0x2b;
    static public final int IDB_INDEX_CREATE = 0x100+0x2c;
    static public final int IDB_INDEX_REMOVE = 0x100+0x2d;
    static public final int IDB_CONSTRAINT_CREATE = 0x100+0x2e;
    static public final int IDB_CONSTRAINT_DELETE = 0x100+0x2f;
    static public final int IDB_COLLECTION_GET_BY_IND = 0x100+0x30;
    static public final int IDB_COLLECTION_GET_BY_VALUE = 0x100+0x31;
    static public final int IDB_SET_OBJECT_LOCK = 0x100+0x32;
    static public final int IDB_GET_OBJECT_LOCK = 0x100+0x33;
    static public final int IDB_ITERATOR_LANG_CREATE = 0x100+0x34;
    static public final int IDB_ITERATOR_DATABASE_CREATE = 0x100+0x35;
    static public final int IDB_ITERATOR_CLASS_CREATE = 0x100+0x36;
    static public final int IDB_ITERATOR_COLLECTION_CREATE = 0x100+0x37;
    static public final int IDB_ITERATOR_ATTRIBUTE_CREATE = 0x100+0x38;
    static public final int IDB_ITERATOR_DELETE = 0x100+0x39;
    static public final int IDB_ITERATOR_SCAN_NEXT = 0x100+0x3a;
    static public final int IDB_EXECUTABLE_CHECK = 0x100+0x3b;
    static public final int IDB_EXECUTABLE_EXECUTE = 0x100+0x3c;
    static public final int IDB_EXECUTABLE_SET_EXTREF_PATH = 0x100+0x3d;
    static public final int IDB_EXECUTABLE_GET_EXTREF_PATH = 0x100+0x3e;
    static public final int IDB_SET_CONN_INFO = 0x100+0x3f;
    static public final int IDB_CHECK_AUTH = 0x100+0x40;
    static public final int IDB_INDEX_GET_COUNT = 0x100+0x41;
    static public final int IDB_INDEX_GET_STATS = 0x100+0x42;
    static public final int IDB_INDEX_SIMUL_STATS = 0x100+0x43;
    static public final int IDB_COLLECTION_GET_IMPLSTATS = 0x100+0x44;
    static public final int IDB_COLLECTION_SIMUL_IMPLSTATS = 0x100+0x45;
    static public final int IDB_INDEX_GET_IMPL = 0x100+0x46;
    static public final int IDB_COLLECTION_GET_IMPL = 0x100+0x47;
    static public final int IDB_OBJECT_PROTECTION_SET = 0x100+0x48;
    static public final int IDB_OBJECT_PROTECTION_GET = 0x100+0x49;
    static public final int IDB_OQL_CREATE = 0x100+0x4a;
    static public final int IDB_OQL_DELETE = 0x100+0x4b;
    static public final int IDB_OQL_GETRESULT = 0x100+0x4c;
    static public final int IDB_SET_LOG_MASK = 0x100+0x4d;
    static public final int IDB_GET_DEFAULT_DATASPACE = 0x100+0x4e;
    static public final int IDB_SET_DEFAULT_DATASPACE = 0x100+0x4f;
    static public final int IDB_DATASPACE_SET_CURRENT_DATAFILE = 0x100+0x50;
    static public final int IDB_DATASPACE_GET_CURRENT_DATAFILE = 0x100+0x51;
    static public final int IDB_GET_DEFAULT_INDEX_DATASPACE = 0x100+0x52;
    static public final int IDB_SET_DEFAULT_INDEX_DATASPACE = 0x100+0x53;
    static public final int IDB_GET_INDEX_LOCATIONS = 0x100+0x54;
    static public final int IDB_MOVE_INDEX = 0x100+0x55;
    static public final int IDB_GET_INSTANCE_CLASS_LOCATIONS = 0x100+0x56;
    static public final int IDB_MOVE_INSTANCE_CLASS = 0x100+0x57;
    static public final int IDB_GET_OBJECTS_LOCATIONS = 0x100+0x58;
    static public final int IDB_MOVE_OBJECTS = 0x100+0x59;
    static public final int IDB_GET_ATTRIBUTE_LOCATIONS = 0x100+0x5a;
    static public final int IDB_MOVE_ATTRIBUTE = 0x100+0x5b;
    static public final int IDB_CREATE_DATAFILE = 0x100+0x5c;
    static public final int IDB_DELETE_DATAFILE = 0x100+0x5d;
    static public final int IDB_MOVE_DATAFILE = 0x100+0x5e;
    static public final int IDB_DEFRAGMENT_DATAFILE = 0x100+0x5f;
    static public final int IDB_RESIZE_DATAFILE = 0x100+0x60;
    static public final int IDB_GET_DATAFILEI_NFO = 0x100+0x61;
    static public final int IDB_RENAME_DATAFILE = 0x100+0x62;
    static public final int IDB_CREATE_DATASPACE = 0x100+0x63;
    static public final int IDB_UPDATE_DATASPACE = 0x100+0x64;
    static public final int IDB_DELETE_DATASPACE = 0x100+0x65;
    static public final int IDB_RENAME_DATASPACE = 0x100+0x66;
    static public final int IDB_GET_SERVER_OUTOFBAND_DATA = 0x100+0x67;
