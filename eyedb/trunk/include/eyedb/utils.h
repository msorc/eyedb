...
class utilsDatabase : public eyedb::Database {
 ...
 public:
  utilsDatabase(const char *s, const char *_dbmdb_str = 0) : eyedb::Database(s, _dbmdb_str) {}
  utilsDatabase(const char *s, int _dbid, const char *_dbmdb_str = 0) : eyedb::Database(s, _dbid, _dbmdb_str) {}
