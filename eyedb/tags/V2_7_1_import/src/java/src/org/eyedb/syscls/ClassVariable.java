...
public class ClassVariable extends ClassComponent {
  ...
  static StructClass make(StructClass ClassVariable_class, org.eyedb.Schema m)
   throws org.eyedb.Exception {
    if (ClassVariable_class == null)
      return new StructClass("class_variable", ((m != null) ? m.getClass("ClassComponent") : ClassComponent.idbclass));
    org.eyedb.Attribute[] attr = new org.eyedb.Attribute[6];
    int[] dims;

    dims = new int[1];
    dims[0] = -1;
    attr[4] = new org.eyedb.Attribute(((m != null) ? m.getClass("char") : Char.idbclass), idbclass, "vname", 4, false, 1, dims);
