...
public class SysUserAccess extends Root {
  ...
  static StructClass make(StructClass SysUserAccess_class, org.eyedb.Schema m)
   throws org.eyedb.Exception {
    if (SysUserAccess_class == null)
      return new StructClass("system_user_access", ((m != null) ? m.getClass("Root") : Root.idbclass));
