...
public class CardinalityConstraint extends AgregatClassComponent {
  ...
  static StructClass make(StructClass CardinalityConstraint_class, org.eyedb.Schema m)
   throws org.eyedb.Exception {
    if (CardinalityConstraint_class == null)
      return new StructClass("cardinality_constraint", ((m != null) ? m.getClass("AgregatClassComponent") : AgregatClassComponent.idbclass));
