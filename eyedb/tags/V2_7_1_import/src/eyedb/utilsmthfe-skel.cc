...
cp utilsmthfe-2.7.0.so $EYEDBROOT/$EYEDBARCH/etc/so/.

#5. Change the file access mode
chmod a+r $EYEDBROOT/$EYEDBARCH/etc/so/utilsmthfe-2.7.0.so
...
Status
__method__OUT_ostring_REF__insert_ostring__IN_int32__IN_string__IN_int32(Database *_db, FEMethod_C *_m, Object *_o, const eyedblib::int32 offset, const char * arg2, const eyedblib::int32 len, OString * &retarg)
{
  _packageInit(_db);
...
Status
__method__OUT_ostring_REF__insert_ostring__IN_int32__IN_string__IN_int32__IN_int32(Database *_db, FEMethod_C *_m, Object *_o, const eyedblib::int32 offset, const char * arg2, const eyedblib::int32 offset2, const eyedblib::int32 len, OString * &retarg)
{
  _packageInit(_db);
...
Status
__method__OUT_int32_last_ostring__IN_string(Database *_db, FEMethod_C *_m, Object *_o, const char * s, eyedblib::int32 &retarg)
{
  _packageInit(_db);
...
Status
__method__OUT_ostring_REF__replace_ostring__IN_int32__IN_int32__IN_string(Database *_db, FEMethod_C *_m, Object *_o, const eyedblib::int32 offset, const eyedblib::int32 len, const char * arg3, OString * &retarg)
{
  _packageInit(_db);
...
Status
__method__OUT_ostring_REF__replace_ostring__IN_int32__IN_int32__IN_string__IN_int32(Database *_db, FEMethod_C *_m, Object *_o, const eyedblib::int32 offset, const eyedblib::int32 len, const char * arg3, const eyedblib::int32 len2, OString * &retarg)
{
  _packageInit(_db);
...
Status
__method__OUT_ostring_REF__replace_ostring__IN_int32__IN_int32__IN_string__IN_int32__IN_int32(Database *_db, FEMethod_C *_m, Object *_o, const eyedblib::int32 offset, const eyedblib::int32 len, const char * arg3, const eyedblib::int32 offset2, const eyedblib::int32 len2, OString * &retarg)
{
  _packageInit(_db);
