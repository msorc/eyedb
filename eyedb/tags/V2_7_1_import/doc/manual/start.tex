...
%%\newcommand{\eyedb}{\textsc{Eyedb} }
%%\newcommand{\eyedb}{EyeDB }
\newcommand{\sysra}{SYSRA}
\newcommand{\indexentry}[2]{\item #1 #2}
%%\newcommand{\pp}[1]{\part{#1} \index{#1}}
...
%\newcommand{\verbsizex}{\scriptsize}
\newcommand{\verbsizex}{\small}
\newcommand{\verbsizey}{\fontsize{8}{\baselineskip}\selectfont}
%\newcommand{\normsize}{\fontsize{10}{\baselineskip}\selectfont}
%\newcommand{\verbsize}{\verbsizey}
%\newcommand{\verbsize}{\verbsizey}
\newcommand{\verbsize}{\normalsize}
%%\newcommand{\support}{eyedb-support@eyedb.org }
\newcommand{\bugreport}{bug-report@eyedb.org }
\newcommand{\idt}{\mbox{ } - }
\newcommand{\ident}{{\bf $<$identifier$>$}}
