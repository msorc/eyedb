...
class sysclsDatabase : public eyedb::Database {
 ...
 public:
  sysclsDatabase(const char *s, const char *_dbmdb_str = 0) : eyedb::Database(s, _dbmdb_str) {}
  sysclsDatabase(const char *s, int _dbid, const char *_dbmdb_str = 0) : eyedb::Database(s, _dbid, _dbmdb_str) {}
  sysclsDatabase(int _dbid, const char *_dbmdb_str = 0) : eyedb::Database(_dbid, _dbmdb_str) {}
  eyedb::Status open(eyedb::Connection *, eyedb::Database::OpenFlag, const char * = 0, const char * = 0);
  eyedb::Status open(eyedb::Connection *, eyedb::Database::OpenFlag, const eyedb::OpenHints *hints, const char * = 0, const char * = 0);
...
class AttributeComponent : public eyedb::Struct {
 ...
 public:
  ...
  eyedb::Oid getClassOwnerOid(eyedb::Status * = 0);
...
class ClassVariable : public ClassComponent {
 ...
 public:
  ...
  eyedb::Oid getValOid(eyedb::Status * = 0);
...
class Index : public AttributeComponent {
 ...
 public:
  ...
  eyedb::Status setIdxOid(Oid);
  Oid getIdxOid(eyedb::Bool *isnull = 0, eyedb::Status * = 0)  const;
...
class HashIndex : public Index {
 ...
 public:
  ...
  eyedb::Oid getHashMethodOid(eyedb::Status * = 0);
...
class ProtectionUser : public eyedb::Struct {
 ...
 public:
  ...
  eyedb::Oid getUserOid(eyedb::Status * = 0);
...
class Protection : public eyedb::Struct {
 ...
 public:
  ...
  eyedb::Status setPoid(Oid);
  Oid getPoid(eyedb::Bool *isnull = 0, eyedb::Status * = 0)  const;
...
class ClassConversion : public eyedb::Struct {
 ...
 public:
  ...
  eyedb::Status setOidO(Oid);
  Oid getOidO(eyedb::Bool *isnull = 0, eyedb::Status * = 0)  const;

  eyedb::Status setOidN(Oid);
  Oid getOidN(eyedb::Bool *isnull = 0, eyedb::Status * = 0)  const;

  eyedb::Status setRoidO(Oid);
  Oid getRoidO(eyedb::Bool *isnull = 0, eyedb::Status * = 0)  const;
  ...
  eyedb::Oid getCnvMthOid(eyedb::Status * = 0);
