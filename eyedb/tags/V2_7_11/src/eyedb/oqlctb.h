...
class oqlctbDatabase : public eyedb::Database {
 ...
 public:
  oqlctbDatabase(const char *s, const char *_dbmdb_str = 0) : eyedb::Database(s, _dbmdb_str) {}
  oqlctbDatabase(const char *s, int _dbid, const char *_dbmdb_str = 0) : eyedb::Database(s, _dbid, _dbmdb_str) {}
...
class OqlCtbDatafile : public eyedb::Struct {
 ...
 public:
  ...
  eyedb::Oid getDspOid(eyedb::Status * = 0);
...
class OqlCtbDataspace : public eyedb::Struct {
 ...
 public:
  ...
  eyedb::Oid getDatafilesOid(unsigned int a0, eyedb::Status * = 0);
