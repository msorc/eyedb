...
eyedb::Status DBUserAccess::dbentry(DBEntry *_dbentry)
{
  ...
  status = getClass()->getAttributes()[2]->setValue(this, (eyedb::Data)&_dbentry, 1, 0);
  return status;
}
...
eyedb::Oid DBUserAccess::dbentry_oid(eyedb::Status *rs) 
{
  gbxAutoGarbSuspender _gbxsusp_;
  eyedb::Oid __tmp;
  eyedb::Status s;
...
eyedb::Status DBUserAccess::user(UserEntry *_user)
{
  ...
  status = getClass()->getAttributes()[3]->setValue(this, (eyedb::Data)&_user, 1, 0);
  return status;
}
...
eyedb::Oid DBUserAccess::user_oid(eyedb::Status *rs) 
{
  gbxAutoGarbSuspender _gbxsusp_;
  eyedb::Oid __tmp;
  eyedb::Status s;
...
eyedb::Oid SysUserAccess::user_oid(eyedb::Status *rs) 
{
  gbxAutoGarbSuspender _gbxsusp_;
  eyedb::Oid __tmp;
  eyedb::Status s;
...
eyedb::Status DBEntry::schm(eyedb::Object *_schm)
{
  ...
  status = getClass()->getAttributes()[6]->setValue(this, (eyedb::Data)&_schm, 1, 0);
  return status;
}
...
eyedb::Oid DBEntry::schm_oid(eyedb::Status *rs) 
{
  gbxAutoGarbSuspender _gbxsusp_;
  eyedb::Oid __tmp;
  eyedb::Status s;
...
eyedb::Status DBEntry::props(unsigned int a0, DBProperty *_props)
{
  ...
  status = getClass()->getAttributes()[8]->setValue(this, (eyedb::Data)&_props, 1, from);
  return status;
}
...
eyedb::Oid DBEntry::props_oid(unsigned int a0, eyedb::Status *rs) 
{
  gbxAutoGarbSuspender _gbxsusp_;
  eyedb::Oid __tmp;
  eyedb::Status s;
...
eyedb::Oid DBPropertyValue::oval_oid(eyedb::Status *rs) 
{
  gbxAutoGarbSuspender _gbxsusp_;
  eyedb::Oid __tmp;
  eyedb::Status s;
...
eyedb::Status DBProperty::value(DBPropertyValue *_value)
{
  ...
  status = getClass()->getAttributes()[3]->setValue(this, (eyedb::Data)&_value, 1, 0);
  return status;
}
...
DBMSchemaUpdate(eyedb::Schema *m, eyedb::Database *db)
{
  ...
  if (!SysAccessMode_class->compare(m->getClass("system_access_mode")))
    return eyedb::Exception::make(IDB_ERROR, "'SysAccessMode' %s", differ_msg);
  if (!DBAccessMode_class->compare(m->getClass("database_access_mode")))
    return eyedb::Exception::make(IDB_ERROR, "'DBAccessMode' %s", differ_msg);
  if (!UserType_class->compare(m->getClass("user_type")))
    return eyedb::Exception::make(IDB_ERROR, "'UserType' %s", differ_msg);
  if (!UserEntry_class->compare(m->getClass("user_entry")))
    return eyedb::Exception::make(IDB_ERROR, "'UserEntry' %s", differ_msg);
  if (!DBUserAccess_class->compare(m->getClass("database_user_access")))
    return eyedb::Exception::make(IDB_ERROR, "'DBUserAccess' %s", differ_msg);
  if (!SysUserAccess_class->compare(m->getClass("system_user_access")))
    return eyedb::Exception::make(IDB_ERROR, "'SysUserAccess' %s", differ_msg);
  if (!DBEntry_class->compare(m->getClass("database_entry")))
    return eyedb::Exception::make(IDB_ERROR, "'DBEntry' %s", differ_msg);
  if (!DBPropertyValue_class->compare(m->getClass("database_property_value")))
    return eyedb::Exception::make(IDB_ERROR, "'DBPropertyValue' %s", differ_msg);
  if (!DBProperty_class->compare(m->getClass("database_property")))
    return eyedb::Exception::make(IDB_ERROR, "'DBProperty' %s", differ_msg);
...
eyedb::Status DBMDatabase::open(eyedb::Connection *ch, eyedb::Database::OpenFlag flag, const char *userauth, const char *passwdauth)
{
    return open(ch, flag, 0, userauth, passwdauth);
}

eyedb::Status DBMDatabase::open(eyedb::Connection *ch, eyedb::Database::OpenFlag flag, const eyedb::OpenHints *hints, const char *userauth, const char *passwdauth)
{
