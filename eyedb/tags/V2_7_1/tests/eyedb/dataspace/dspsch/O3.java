...
public class O3 extends org.eyedb.Struct {
  ...
  static StructClass make(StructClass O3_class, org.eyedb.Schema m)
   throws org.eyedb.Exception {
    if (O3_class == null)
      return new StructClass("O3", ((m != null) ? m.getClass("org.eyedb.Struct") : org.eyedb.Struct.idbclass));
    org.eyedb.Attribute[] attr = new org.eyedb.Attribute[4];
    int[] dims;

    dims = null;
    attr[2] = new org.eyedb.Attribute(((m != null) ? m.getClass("int") : Int32.idbclass), idbclass, "n3", 2, false, 0, dims);

    dims = new int[1];
    dims[0] = -1;
    attr[3] = new org.eyedb.Attribute(((m != null) ? m.getClass("char") : Char.idbclass), idbclass, "data3", 3, false, 1, dims);
