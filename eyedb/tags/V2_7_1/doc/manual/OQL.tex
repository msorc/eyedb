...
\subsubsect{\texttt{exists/in} Operator}
...
As explained in the Section \emph{OQL vs. ODMG 2.0 OQL},
...
//
// substring(str, f, len): same as str[f:f+len]
//
