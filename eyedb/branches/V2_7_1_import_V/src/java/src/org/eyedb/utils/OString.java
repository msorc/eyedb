...
public class OString extends Root {
  ...
  static StructClass make(StructClass OString_class, org.eyedb.Schema m)
   throws org.eyedb.Exception {
    if (OString_class == null)
      return new StructClass("ostring", ((m != null) ? m.getClass("Root") : Root.idbclass));
    org.eyedb.Attribute[] attr = new org.eyedb.Attribute[3];
    int[] dims;

    dims = new int[1];
    dims[0] = -1;
    attr[2] = new org.eyedb.Attribute(((m != null) ? m.getClass("char") : Char.idbclass), idbclass, "s", 2, false, 1, dims);
