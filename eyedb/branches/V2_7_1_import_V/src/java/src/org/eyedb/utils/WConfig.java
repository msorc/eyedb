...
public class WConfig extends Root {
  ...
  static StructClass make(StructClass WConfig_class, org.eyedb.Schema m)
   throws org.eyedb.Exception {
    if (WConfig_class == null)
      return new StructClass("w_config", ((m != null) ? m.getClass("Root") : Root.idbclass));
    ...
    dims = new int[1];
    dims[0] = -1;
    attr[3] = new org.eyedb.Attribute(((m != null) ? m.getClass("char") : Char.idbclass), idbclass, "user", 3, false, 1, dims);

    dims = new int[1];
    dims[0] = -1;
    attr[4] = new org.eyedb.Attribute(((m != null) ? m.getClass("char") : Char.idbclass), idbclass, "conf", 4, false, 1, dims);
