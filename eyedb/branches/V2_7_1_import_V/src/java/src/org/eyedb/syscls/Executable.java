...
public class Executable extends Root {
  ...
  static StructClass make(StructClass Executable_class, org.eyedb.Schema m)
   throws org.eyedb.Exception {
    if (Executable_class == null)
      return new StructClass("executable", ((m != null) ? m.getClass("Root") : Root.idbclass));
    org.eyedb.Attribute[] attr = new org.eyedb.Attribute[8];
    int[] dims;

    dims = new int[1];
    dims[0] = -1;
    attr[2] = new org.eyedb.Attribute(((m != null) ? m.getClass("char") : Char.idbclass), idbclass, "exname", 2, false, 1, dims);
    ...
    dims = new int[1];
    dims[0] = -1;
    attr[6] = new org.eyedb.Attribute(((m != null) ? m.getClass("char") : Char.idbclass), idbclass, "intname", 6, false, 1, dims);

    dims = new int[1];
    dims[0] = -1;
    attr[7] = new org.eyedb.Attribute(((m != null) ? m.getClass("char") : Char.idbclass), idbclass, "extref_body", 7, false, 1, dims);
